...
class CoctMt090000Uv01RoleOther:
    ...
    class_code: Optional[Union[RoleClassMutualRelationship, RoleClassPassive, str, RoleClassOntological, RoleClassPartitive, "CoctMt090000Uv01RoleOther.Value"]] = field(
        default=None,
        metadata=dict(
            name="classCode",
            type="Attribute",
...
class CoctMt090000Uv01Member:
    ...
    group: Optional[CoctMt090000Uv01Group] = field(
        default=None,
        metadata=dict(
            type="Element",
            namespace="urn:hl7-org:v3",
    ...
    class_code: Union[RoleClassMutualRelationship, RoleClassPassive, str, RoleClassOntological, RoleClassPartitive, "CoctMt090000Uv01Member.Value", XAccommodationRequestorRole, XDocumentEntrySubject, XDocumentSubject, XInformationRecipientRole, XRoleClassAccommodationRequestor, XRoleClassCoverage, XRoleClassCoverageInvoice, XRoleClassCredentialedEntity, XRoleClassPayeePolicyRelationship] = field(
        init=False,
...
class CoctMt090000Uv01Device:
    ...
    as_licensed_entity: List[CoctMt090000Uv01LicensedEntity] = field(
        default_factory=list,
        metadata=dict(
    ...
    as_member: List[CoctMt090000Uv01Member] = field(
        default_factory=list,
        metadata=dict(
            name="asMember",
            type="Element",
    ...
    as_role_other: List[CoctMt090000Uv01RoleOther] = field(
        default_factory=list,
        metadata=dict(
            name="asRoleOther",
            type="Element",
    ...
    language_communication: List[CoctMt090000Uv01LanguageCommunication] = field(
        default_factory=list,
        metadata=dict(
...
class CoctMt090000Uv01AssignedEntity:
    ...
    assigned_person: Optional[CoctMt090000Uv01Person] = field(
        default=None,
        metadata=dict(
            name="assignedPerson",
            type="Element",
    ...
    assigned_device: Optional[CoctMt090000Uv01Device] = field(
        default=None,
        metadata=dict(
            name="assignedDevice",
            type="Element",
    ...
    assigned_organization: Optional[CoctMt090000Uv01Organization] = field(
        default=None,
        metadata=dict(
