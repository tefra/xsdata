...
class CoctMt090002Uv01AssignedEntity:
    ...
    assigned_person: Optional[CoctMt090002Uv01Person] = field(
        default=None,
        metadata=dict(
            name="assignedPerson",
            type="Element",
    ...
    assigned_device: Optional[CoctMt090002Uv01Device] = field(
        default=None,
        metadata=dict(
            name="assignedDevice",
            type="Element",
    ...
    assigned_organization: Optional[CoctMt090002Uv01Organization] = field(
        default=None,
        metadata=dict(
