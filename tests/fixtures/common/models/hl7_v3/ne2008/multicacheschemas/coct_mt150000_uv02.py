...
class CoctMt150000Uv02OrganizationContains:
    ...
    part_organization: Optional["CoctMt150000Uv02Organization"] = field(
        default=None,
        metadata=dict(
            name="partOrganization",
            type="Element",
            namespace="urn:hl7-org:v3",
            nillable=True
        )
...
class CoctMt150000Uv02OrganizationPartOf:
    ...
    whole_organization: Optional["CoctMt150000Uv02Organization"] = field(
        default=None,
        metadata=dict(
...
class CoctMt150000Uv02ContactParty:
    ...
    contact_person: Optional[CoctMt150000Uv02Person] = field(
        default=None,
        metadata=dict(
            name="contactPerson",
            type="Element",
...
class CoctMt150000Uv02Organization:
    ...
    as_organization_part_of: List[CoctMt150000Uv02OrganizationPartOf] = field(
        default_factory=list,
        metadata=dict(
    ...
    organization_contains: List[CoctMt150000Uv02OrganizationContains] = field(
        default_factory=list,
        metadata=dict(
