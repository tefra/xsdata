...
@dataclass
class PrpaIn201302Uv02MfmiMt700701Uv01Subject2:
    """
    :ivar realm_code:
    :ivar type_id:
    :ivar template_id:
    ...
    """
    class Meta:
        name = "PRPA_IN201302UV02.MFMI_MT700701UV01.Subject2"
    ...
    patient: Optional[PrpaMt201302Uv02Patient] = field(
        default=None,
        metadata=dict(
            type="Element",
            namespace="urn:hl7-org:v3",
...
@dataclass
class PrpaIn201302Uv02MfmiMt700701Uv01RegistrationEvent:
    """
    :ivar realm_code:
    :ivar type_id:
    :ivar template_id:
    ...
    """
    class Meta:
        name = "PRPA_IN201302UV02.MFMI_MT700701UV01.RegistrationEvent"
    ...
    subject1: Optional[PrpaIn201302Uv02MfmiMt700701Uv01Subject2] = field(
        default=None,
        metadata=dict(
            type="Element",
            namespace="urn:hl7-org:v3",
...
@dataclass
class PrpaIn201302Uv02MfmiMt700701Uv01Subject1:
    """
    :ivar realm_code:
    :ivar type_id:
    :ivar template_id:
    ...
    """
    class Meta:
        name = "PRPA_IN201302UV02.MFMI_MT700701UV01.Subject1"
    ...
    registration_event: Optional[PrpaIn201302Uv02MfmiMt700701Uv01RegistrationEvent] = field(
        default=None,
        metadata=dict(
...
@dataclass
class PrpaIn201302Uv02MfmiMt700701Uv01ControlActProcess:
    """
    :ivar realm_code:
    :ivar type_id:
    :ivar template_id:
    ...
    """
    class Meta:
        name = "PRPA_IN201302UV02.MFMI_MT700701UV01.ControlActProcess"
    ...
    subject: List[PrpaIn201302Uv02MfmiMt700701Uv01Subject1] = field(
        default_factory=list,
        metadata=dict(
            type="Element",
            namespace="urn:hl7-org:v3",
...
@dataclass
class PrpaIn201302Uv02McciMt000100Uv01Message:
    """
    :ivar realm_code:
    :ivar type_id:
    :ivar template_id:
    ...
    """
    class Meta:
        name = "PRPA_IN201302UV02.MCCI_MT000100UV01.Message"
    ...
    control_act_process: Optional[PrpaIn201302Uv02MfmiMt700701Uv01ControlActProcess] = field(
        default=None,
        metadata=dict(
...
@dataclass
class PrpaIn201302Uv02(PrpaIn201302Uv02McciMt000100Uv01Message):
    """
    :ivar itsversion:
    """
    class Meta:
