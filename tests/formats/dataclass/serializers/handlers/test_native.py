...
from xsdata.formats.dataclass.serializers.handlers.native import XmlContentWriter


class XmlContentWriterTests(TestCase):
    def setUp(self):
        self.serializer = XmlSerializer(pretty_print=True, handler=XmlContentWriter)
